...
## Getting Started
*Clone this repository using your favorite git client on either Windows or Linux . Setup your Web Development Environment  ie.
your browsers , IDE , Code Editors and various extension you will need base on your editor or IDE . Create a database for
the Website and  Host it using your local web server*
...
### Prerequisites
1. To get started install a Typescrip(ES6) runtime environment like *Deno* or *Node*
2. Install the various package that will be needed for our development environment.
3. Setup the database locally on your machine .
4. Host the site using ur favorite webserver (Apache / Nginx )
...
-->
How to install some of the need tools in Linux
```bash
...
Please read [CONTRIBUTING.md](https://github.com/Animosusoft/WebHealthManagement/blob/master/CONTRIBUTING.md) for details on our code of conduct, and the process for submitting pull requests to us.
...
* **Newman && Bernard** -
*Initial work was by* - [Ultra-Code](https://github.com/Ultra-Code)
...
* PurpleBooth and embeddedartistry for their creative works

* Thanks to the KNUST BUSINESS INOVATION HUB
